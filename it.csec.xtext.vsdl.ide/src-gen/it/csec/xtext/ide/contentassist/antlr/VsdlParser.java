...
public class VsdlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, VsdlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getIdAssignment_0_1(), "rule__NodeNetworkConstraintA__IdAssignment_0_1");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getOpAssignment_0_4(), "rule__NodeNetworkConstraintA__OpAssignment_0_4");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getIpAddressAssignment_0_6(), "rule__NodeNetworkConstraintA__IpAddressAssignment_0_6");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getIdAssignment_1_1(), "rule__NodeNetworkConstraintA__IdAssignment_1_1");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getOpAssignment_1_4(), "rule__NodeNetworkConstraintA__OpAssignment_1_4");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getIpRangeAssignment_1_6(), "rule__NodeNetworkConstraintA__IpRangeAssignment_1_6");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getIdAssignment_2_1(), "rule__NodeNetworkConstraintA__IdAssignment_2_1");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getOpAssignment_2_5(), "rule__NodeNetworkConstraintA__OpAssignment_2_5");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getNodeAssignment_2_7(), "rule__NodeNetworkConstraintA__NodeAssignment_2_7");
			...
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getIdAssignment_4_1(), "rule__NodeNetworkConstraintA__IdAssignment_4_1");
			builder.put(grammarAccess.getNodeNetworkConstraintAAccess().getDNSIPAssignment_4_4(), "rule__NodeNetworkConstraintA__DNSIPAssignment_4_4");
